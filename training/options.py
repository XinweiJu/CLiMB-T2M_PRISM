...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--depth_aux", choices=["none", "edge", "lum"],
                                 default="none",
                                 help="auxiliary channel supplied to the depth encoder")
        self.parser.add_argument("--pose_aux", choices=["none", "edge", "lum"],
                                 default="none",
                                 help="auxiliary channel supplied for each pose image")
        self.parser.add_argument("--motion_aux", choices=["none", "tracks", "flow"],
                                 default="none",
                                 help="fifth per-image channel loaded from --motion_root")
        self.parser.add_argument("--motion_fusion", choices=["channel", "add", "blend"],
                                 default="channel",
                                 help="append motion as a channel, or fuse it into the existing auxiliary channel")
        self.parser.add_argument("--motion_alpha", type=float, default=0.2,
                                 help="motion strength for add/blend auxiliary fusion")
        self.parser.add_argument("--motion_root", type=str, default=None,
                                 help="root containing <tracks|flow>/<sequence>/<frame>.png")
        self.parser.add_argument("--shading_root", type=str, default=None,
                                 help="Hyper-Kvasir shading root containing models/weights_19")
        self.parser.add_argument("--edge_root", type=str, default=None,
                                 help="Hyper-Kvasir DexiNed edge root")
        self.parser.add_argument("--freeze_depth", action="store_true",
                                 help="freeze depth encoder/decoder (stage 3)")
        self.parser.add_argument("--freeze_pose", action="store_true",
                                 help="freeze pose encoder/decoder for depth-only fine-tuning")
        ...
        self.parser.add_argument("--num_workers",
                                 ...
                                 default=12)
        self.parser.add_argument("--benchmark_batches",
                                 type=int,
                                 default=0,
                                 help="stop after N batches and report throughput/peak memory")
        ...
        self.parser.add_argument("--load_optimizer", action="store_true",
                                 help="also resume adam.pth when parameter groups match")
